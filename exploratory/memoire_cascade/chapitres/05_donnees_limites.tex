...
confondues, et $0{,}21$ pour les firmes les mieux couvertes, celles dont le
profil se rapproche d'une entité soumise à DORA. Ces valeurs sont sans commune
mesure avec le taux posé dans le modèle. L'écart n'est pas une erreur de
...
\midrule
$\lambda_{ref}$ & PRC & $341$/an & notifications de violation de données sur le périmètre
PRC, tous acteurs confondus. Sert à \emph{répartir} par vecteur d'attaque, pas à fixer un
niveau de capital. \\
...
porte le capital. \\
$\lambda_{\text{entité}}$ & OpRisk & $0{,}10$ à $0{,}21$/an & les mêmes incidents matériels,
rapportés à \emph{une} firme. C'est l'échelle de lecture d'une entité soumise à DORA. \\
\bottomrule
\end{tabular}
\end{center}
\vspace{2pt}
Le facteur $1\,600$ entre les extrêmes n'est donc pas une incohérence : c'est l'écart entre
un comptage de notifications, un comptage de pertes matérielles sectorielles et un comptage
de pertes matérielles par entité. \textbf{Seul $\lambda$ alimente le moteur}, et c'est lui
...
multipliée par $0{,}86$, soit $-14\,\%$. Le biais de taille n'explique pas un facteur dix ; il
explique un septième. \textbf{Ce n'est pas la sévérité qui rend le niveau non transposable,
c'est la fréquence}, ce que la table~\ref{tab:echelle} établit par ailleurs.
...
\includegraphics[width=\linewidth]{S18_biais_taille_troncature.png}
