...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{../vasicek_lab/figures/D1_presence_croisee.png}
\caption{Taux de présence croisée des variables de la chronologie PRC. La lecture utile est la
ligne du bas : le volume touché n'est simultanément renseigné avec le type de brèche que dans
$25{,}1\,\%$ des cas, et avec la date de fin d'exposition dans $12{,}5\,\%$.}
\label{fig:presence-croisee}
\end{figure}

La matrice croisée dit ce qu'une colonne de taux isolés ne dit pas : les lacunes se
\emph{cumulent}. Une analyse qui croiserait le volume touché, le type de brèche et la durée
