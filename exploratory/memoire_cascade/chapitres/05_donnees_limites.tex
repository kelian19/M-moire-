...
pic, faute de notifications déjà enregistrées.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{../vasicek_lab/figures/D4_composition_temporelle.png}
...
par type d'organisation. Les deux ordres divergent sur \textbf{quatre types sur sept} : le
commerce de détail est sixième en nombre et quatrième en volume, l'enseignement quatrième en
nombre et cinquième en volume.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{../vasicek_lab/figures/D5_organisation_double_axe.png}
