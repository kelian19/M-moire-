...
extrême. C'est pourquoi la fréquence d'occurrence est ici conditionnée au profil de l'entité
par le modèle de Vasicek (chapitre~\ref{chap:cascade}).
...
d'activité au profit du seul risque de compromission de données. Pour corriger ce biais, la
structure des vecteurs d'attaque de la base Hackmageddon, qui couvre l'ensemble du spectre,
rançongiciels compris, est superposée à la fréquence de base issue de la PRC.
...
sectoriels situent entre $5$ et $10\,\%$ par an. Le mémoire \emph{suppose} que les bases
commerciales employées intègrent déjà cette homogénéisation monétaire. L'hypothèse n'est pas
vérifiable sur la donnée disponible ; si elle est fausse, elle minore les sinistres anciens
ramenés en euros courants, donc minore la queue et le capital. Aucun indice d'inflation
spécifique au cyber ne fait aujourd'hui consensus.
...
582 incidents sur la période 2000--2026.
