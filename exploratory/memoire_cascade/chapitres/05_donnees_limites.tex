...
\noindent Source : script~\texttt{63}, qui liste les trois sources et leur rôle.
...
\noindent Sources : scripts~\texttt{57} (biais de troncature et de taille), \texttt{62}
et~\texttt{63} (coefficients de la conversion Jacobs et indice de queue PRC avec son
intervalle, qui sont des constantes de la calibration figée).
...
\noindent Sources de cette section : script~\texttt{63}, qui imprime les comptages et les
parts sous l'étiquette \og{}citation externe, non recalculable\fg{}. L'étiquette est le point :
ces chiffres entrent dans le mémoire comme une citation datée, pas comme un calcul, et le
script le dit à la place du lecteur.
...
\]
Le dernier terme est le quantile de la \textbf{sévérité} d'un sinistre, pas un capital : le
...
\noindent Sources : scripts~\texttt{05}, qui teste la faisabilité de l'identification,
et~\texttt{63} pour les constantes de la calibration figée qui y sont rappelées.
...
\noindent Sources : scripts~\texttt{05}, \texttt{62} et~\texttt{63}, ce dernier enregistrant
sous le statut de \emph{citation externe non recalculable} les trois valeurs empruntées au
rapport de l'agence européenne, ainsi que les parts par vecteur de la source médiatique.
