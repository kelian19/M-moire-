...
\og P1 entraîne P2 plus que l'inverse\fg{}, alors que nos données d'expert sont dirigées à
...
\noindent Source : script~\texttt{01}, qui mesure la part dirigée du classeur d'expert par le
rapport de l'asymétrie de $\mathrm{TRANS}$ à son intensité, et donne les trois paires dont
l'écart est le plus fort. Le script~\texttt{03} en dérive la normalisation.
...
$R_0=\mathbf{0{,}054}$ : les deux lectures sont stables, mais pas du même ordre.
\end{cle}
...
\noindent Sources de cette section : scripts~\texttt{04}, qui balaie la barre de matérialité
et imprime le biais résiduel sur le capital, et~\texttt{02}, qui chiffre ce biais pour
l'ajustement de queue et pour la lognormale.
