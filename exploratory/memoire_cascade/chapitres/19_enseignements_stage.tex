...
critique des affirmations qualitatives du modèle, et deux consultants de Nexialog
ont répondu. La contribution de la première n'est pas de celles qu'on espère et elle est
plus utile que celle qu'on espérait : elle n'a contredit aucune des sept affirmations, mais
...
arc d'un canal à l'autre, donc à recalibrer, ce que le gel interdit. Le second, expert
de la résilience, a contredit deux affirmations en décrivant des boucles de rétroaction entre
domaines, et avancé de lui-même la cause commune comme explication concurrente de la
contagion. Son désaccord est déclaré, et il ne déplace pas le capital publié, calculé sans fixer
la direction. Les répondants ne sont pas nommés. Le second codage n'est pas le préalable du résultat mais son
