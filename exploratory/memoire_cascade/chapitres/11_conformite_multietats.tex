...
\noindent Chiffres de cette sous-section : script~\texttt{69}.
...
Deux remarques pour finir, et elles vont en sens opposés. Cette quasi-additivité est le même fait
que l'interaction entre piliers déjà publiée, petite devant la somme des marginaux et de signe
non résolu (\S\ref{sec:allocation}) : deux lectures d'un seul constat, et l'ordre des
contributions additives reproduit celui des marginaux, $P1 > P4 > P2 > P3 > P5$. Mais
l'invariance porte sur l'\textbf{espérance} : une conférence de conformité déplace bien la loi
des configurations, donc elle déplacerait un quantile de cette loi ou une mesure de sa queue. Ce
qui est établi ici est que le capital espéré n'en voit rien, non que le phénomène soit sans
conséquence sur toute grandeur.
