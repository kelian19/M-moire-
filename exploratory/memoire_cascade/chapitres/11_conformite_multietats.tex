...
\paragraph{Mais l'argument porte sur une espérance, et le capital est un quantile.} Ce qui vient
d'être établi concerne la \emph{moyenne des VaR conditionnelles} aux $32$ configurations. Un
lecteur qui demande le capital d'une entité dont l'état de conformité est incertain demande le
quantile de la loi \textbf{mélangée} sur ces configurations, et l'argument d'additivité ne
s'étend pas à ce second objet, puisqu'il repose sur la linéarité de l'espérance. Les deux ont
donc été calculés : ils diffèrent de $9{,}3\,\%$, et \textbf{le mémoire publie la première
grandeur}. Sur le quantile, le déplacement n'est pas monotone en $\delta$ et reste du même ordre
que le bruit de tirage, de sorte que \textbf{l'invariance n'y est pas démontrée, elle est
seulement non détectée} : énoncé strictement plus faible que sur l'espérance. La conclusion de
gestion ne change pas, c'est son \emph{statut} qui change. Les deux niveaux, leur écart et le
bruit qui les encadre sont donnés au \S\ref{sec:ann-corrections-instrument}.
