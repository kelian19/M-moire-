...
bornes du chapitre~\ref{chap:partielle}. Le SCR dépend de l'état de conformité de
l'entité, objet ni binaire ni statique. On le modélise à deux échelles de temps
(\emph{fast-slow}). À l'échelle rapide, un Vasicek multi-états définit l'état (non
conforme, partiellement conforme, conforme) de chaque pilier et le fait piloter la cascade. À
l'échelle lente, une chaîne de Markov fait progresser la conformité le long de la
...
L'état de conformité agit sur la cascade par trois canaux, câblés sans réécrire
...
\item \textbf{Propagation} $g$ : une entité plus conforme contient mieux la contagion, donc un
  ...
  avec un gain indexé sur l'état du pilier source.
...
\textbf{sens} de l'écart sont donc invariants à la calibration ; seule son amplitude
est un scénario.
...
quantile de la loi mélangée sur ces configurations, et l'argument d'additivité ne
s'étend pas à ce second objet, puisqu'il repose sur la linéarité de l'espérance. Les deux ont
donc été calculés : ils diffèrent de $9{,}3\,\%$, et le mémoire publie la première
grandeur. Sur le quantile, le déplacement n'est pas monotone en $\delta$ et reste du même ordre
que le bruit de tirage, de sorte que l'invariance n'y est pas démontrée, elle est
