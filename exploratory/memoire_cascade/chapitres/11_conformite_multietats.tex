...
\item \emph{Fréquence} $\lambda$ : l'état module le nombre d'incidents amorcés, de $21{,}56$
...
\item \emph{Propagation} $g$ : une entité plus conforme contient mieux la contagion, donc un
...
\item \emph{Détection} $p_u$ : le taux de matérialité (le seuil de détection du
...
\item \emph{Accumulation par un prestataire commun} : à l'état non conforme, un incident amorcé
