...
les leviers à l'inverse parce que sa sévérité est bornée, sont au
\S\ref{sec:ann-sensibilite-propagation}.
% SOURCES-SCRIPTS: 81
...
peut renseigner (\S\ref{sec:ann-regard-reglementaire}).
...
l'échelle proportionnelle et les figures sont au \S\ref{sec:ann-ancrage}.
...
module de plus, corrélé à $\rho$ avec le \textsc{bscr} : un montant petit devant le \textsc{bscr}
n'y est reconnu qu'à hauteur de $\rho$, quand la convention additive le reconnaît en entier. Sur
les quatre bilans réels, le \textsc{bscr} n'étant que minoré, les taux lus sont des majorants
(\S\ref{sec:ann-agregation}).
