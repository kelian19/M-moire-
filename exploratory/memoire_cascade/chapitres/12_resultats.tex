...
% SOURCES-SCRIPTS: 67
Ce rapport \textbf{dépend de l'état} et il faut
...
non la sévérité, qui porte l'agrégat à une échelle de secteur.}{fig:benchmark-externe}
% SOURCES-SCRIPTS: 49
...
conformité \emph{supposé}. Les identités et les références \textsc{sfcr} exactes sont tenues hors
