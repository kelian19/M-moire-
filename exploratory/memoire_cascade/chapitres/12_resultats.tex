...
soit respectivement $+51{,}5\,\%$ et $+53{,}7\,\%$ au-dessus du socle : le point d'expert
...
\textbf{protocole}, jamais sur l'ordre d'un résultat en queue. Un lecteur qui ouvrirait
...
nos quantiles tombent exactement dans la fourchette des grandes pertes cyber réelles
...
Ensuite, et c'est le point à ne pas maquiller, la coïncidence avec la Formule Standard
...
tirer n'est pas que le modèle est faux : c'est que le niveau du forfait ne dit rien
...
qu'il ne faut pas confondre. (a)~au niveau du \emph{sinistre unique}, nos quantiles
...
module \textsc{dora} dans la Formule Standard : la grandeur calculée ici est un besoin de
...
la seconde. Le forfait n'est donc pas une borne : il se trompe dans les deux sens, de
...
mémoire tombant au milieu d'elles. (b)~le besoin et sa bande d'identification face à la
charge forfaitaire, en échelle logarithmique : le forfait croît avec les provisions, la charge de
contagion beaucoup moins vite, et c'est tout le sujet. (c)~le besoin rapporté au
