...
chapitre~\ref{chap:resultats}). Les trois dernières sont des limites, et elles ne portent
...
(C.~Hillairet). Deux réponses complémentaires, selon la posture (figure~\ref{fig:robuste} et
\S\ref{sec:ann-postures}).
...
sont un seul nombre à la précision du bruit. Le détail est au \S\ref{sec:ann-postures}.
% SOURCES-SCRIPTS: 46
