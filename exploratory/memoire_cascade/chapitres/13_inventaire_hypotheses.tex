...
\vspace{4pt}
\noindent La lecture est nette. Les deux seuls écarts \emph{involontaires} sous-estiment le
capital, de quelques pour cent chacun ; les trois choix \emph{délibérés} le majorent, et de
beaucoup plus. Le mémoire ne se protège donc pas derrière ses erreurs, il les déclare, et sa
prudence vient d'ailleurs, de choix assumés qu'il nomme comme tels. C'est aussi pourquoi
corriger les deux premiers ne changerait aucune conclusion : ils sont dominés d'un ordre de
grandeur par les seconds. Sources : scripts~\texttt{08b}, \texttt{47} et~\texttt{63}.
