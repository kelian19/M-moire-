...
\emph{surestimerait} l'effet d'un facteur trois. Et elle ne touche que le \emph{niveau} : la thèse
porte sur un rapport entre états à sévérité de base commune, et une dérive commune aux deux états
s'y simplifie. Le même backtest valide par ailleurs la loi de fréquence et la forme de la queue,
de sorte que cette ligne est le prix d'un test dont le solde est favorable
...
et~\texttt{89} (backtest hors échantillon et dérive d'échelle).
