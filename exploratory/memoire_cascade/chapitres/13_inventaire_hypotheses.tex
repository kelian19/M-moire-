...
La démonstration se fait en deux temps : (i)~elles sont insensibles aux choix de modélisation
...
\section{Le moteur d'agrégation, contrôlé par trois chemins indépendants}
...
se calcule aussi sans simuler, et c'est ce que fait cette section.
...
Panjer, laquelle est inexploitable telle quelle à l'indice de queue publié, où elle demanderait
de plusieurs millions de points parcourue de proche en proche. L'\textbf{approximation par perte
unique} exploite la sous-exponentialité de la sévérité, sous laquelle la survie de la somme vaut
...
l'état. L'écart de l'inversion vaut $0{,}75$ et $0{,}59$ erreur type, donc \textbf{il n'est pas
...
résultat que ce contrôle pouvait rendre, et c'est aussi la raison de ne pas citer le $-1{,}7\,\%$
...
simulée de cette section est désormais publiée avec son bruit, ce qui rend la question
