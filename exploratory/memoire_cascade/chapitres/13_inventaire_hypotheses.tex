...
\paragraph{Sur le rejet de l'auto-excitation, une corroboration extérieure.} Le choix de ne pas
poser de couche de Hawkes est celui qui prête le plus le flanc, l'auto-excitation étant devenue
l'outil par défaut du cyber. Il est ici adossé à un test contre les variantes de noyau de la
littérature, et il reçoit une confirmation d'un autre côté : le préprint de cascade climatique
cité au chapitre~\ref{chap:etat-art} \citep{ccrn2026} écarte le même outil, et \emph{pour la même
raison de résolution temporelle}, en retenant un graphe acyclique à l'échelle de l'événement
plutôt qu'un processus ponctuel auto-excité. Leur argument est que le Hawkes devient naturel
lorsque les instants exacts et la rétroaction récurrente sont au c\oe ur du problème, ce qui
n'est pas le cas quand la propagation se joue à l'intérieur d'un événement dont on n'observe pas
la chronologie fine. C'est exactement la situation du présent travail, et cette convergence est
d'autant plus utile qu'elle est indépendante : elle vient d'un autre péril, d'une autre équipe,
et sans connaissance des travaux sur lesquels le rejet s'appuie ici.
...
juge de la difficulté. Le préprint de cascade climatique cité au chapitre~\ref{chap:etat-art}
