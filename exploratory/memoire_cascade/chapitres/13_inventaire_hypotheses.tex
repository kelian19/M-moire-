...
la Formule Standard n'a pas. Reste une incertitude irréductible, la queue de sévérité, qui est
assumée en présentant le besoin de capital comme une distribution, jamais un point.
\end{cle}
...
\rob \\
L'\emph{asymétrie} de $W$ départage les deux piliers de tête &
...
\emph{délibérés} le majorent. Le mémoire ne se protège donc pas derrière ses erreurs, il les
déclare, et sa prudence vient de choix assumés qu'il nomme comme tels. L'indice de queue n'est
