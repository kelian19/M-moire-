...
$3{,}34$. Les canaux isolés en expliquent $9\,138$~M\euro{} d'un écart de $14\,139$, leur
interaction en portant $5\,001$, soit
$35\,\%$, parce que les canaux se composent presque comme un produit : un plan de
remédiation doit donc citer l'effet de fermeture d'un canal et non son effet isolé. La fréquence
est le levier qui commande : seule, elle porte le besoin de capital à $10\,377$~M\euro{}, facteur
que la forme fermée de la perte unique retrouve à moins de $1\,\%$, et toute cible au-delà de
$11\,413$~M\euro{} l'exige. Ce montant
...
bougé. Il est décrit \matcomp, avec ce qu'il ne garantit pas, car il ne vérifie
ni qu'un nombre est au bon endroit ni qu'il veut dire ce que la phrase prétend.

% SOURCES-SCRIPTS: 28 39 43 68 92 47 89 91 85 100
...
le schéma VERIS, standard de description d'incidents adopté par la profession, porte
...
identifiable, et la contagion ajoute une bande explicite au-dessus de ce socle. Dans la
configuration retenue pour ce calcul, le capital se situe entre $6\,858$ et $8\,697$~M\euro{} sur
les $1\,024$ sommets de l'ensemble admissible. La largeur de cette bande, $1\,839$~M\euro{}, est le
coût en capital de l'ignorance de la direction : il est connu d'avance plutôt que subi, et c'est
la réponse que ce mémoire donne à la question du montant.
...
schéma VERIS : la recommandation ne demande donc pas d'inventer une taxonomie, elle
...
bornes qu'elle apporterait, et la hiérarchise par dépendance. Retenu sur les six dépendances dont
le corpus documentaire établit le sens, un tel registre ferait tomber la largeur de la bande de
$66\,\%$. Et la hiérarchie est très inégale : documenter la seule dépendance entre gouvernance et
gestion des incidents lèverait $28{,}9\,\%$ de l'ambiguïté de capital, quand documenter le lien
entre tests et prestataires tiers n'en lèverait rien. Un superviseur qui ne pourrait exiger qu'un
seul champ sait donc lequel demander. La limite d'identifiabilité
...
\section{Limites}
L'élicitation structurée a été préparée et diffusée, et elle est restée sans réponse
(annexe~\ref{ch:elicitation}) : la lecture centrale de la direction repose donc sur un classeur
qualitatif, non sur une agrégation d'experts pondérée. Deux hypothèses pèsent le plus sans être testables sur la donnée : les
...
deux-là dominent, pas lequel remédier d'abord sans un dire d'expert. Cette dépendance se chiffre
plutôt qu'elle ne se déclare. En dégradant l'émission de la gouvernance pour simuler le biais
d'une source qui la sur-attribue, le classement tient jusqu'à une dégradation du quart et bascule
vers la gestion des tiers à la moitié, tandis que le niveau de capital, lui, ne perd que
$24{,}8\,\%$ même lorsque la gouvernance est rendue entièrement muette, soit $0{,}81$ fois la
largeur de la bande d'identification déjà publiée. Le niveau résiste, le classement non.

% SOURCES-SCRIPTS: 74 64
