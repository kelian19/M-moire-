...
vaut plusieurs fois la sinistralité attendue, un traité en excès de perte correctement
dimensionné réduit le coût total de moitié, et la remédiation déplace ce point d'équilibre en
plus d'abaisser le capital. Le niveau reste illustratif, mais le \emph{rapport} entre coût de
détention et prix de transfert est, lui, une grandeur d'entité, puisque ses deux termes se
rapportent au même SCR. C'est la lecture décisionnelle que le travail visait.
