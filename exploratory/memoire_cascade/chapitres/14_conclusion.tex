...
niveau, et pour une raison qui est une \textbf{identité} plutôt qu'une mesure : ses deux termes
...
historique. Ce qui subsiste est un effet de \textbf{forme}, la descente d'échelle déplaçant la
...
\noindent Sources : scripts~\texttt{58}, \texttt{65} et~\texttt{67}.
