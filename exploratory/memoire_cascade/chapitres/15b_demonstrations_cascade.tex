...
n'est ni une coïncidence ni un artefact d'arrondi : c'est la propriété d'efficience
...
marginales le long de $\pi$ est télescopique :
\[
...
\paragraph{Portée et limite de l'efficience.}
...
\emph{pas} que la part d'un joueur soit une prédiction de ce qu'on obtiendrait en l'écartant
