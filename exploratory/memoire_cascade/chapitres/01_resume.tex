...
des raisons distinctes, et le schéma VERIS porte les deux champs requis sans les
...
reasons, and the VERIS schema carries the two required fields yet populates both in only
