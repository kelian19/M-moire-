...
Standard. À l'échelle d'une entité notionnelle, il se situe entre $131{,}5$ et $183{,}3$~M\euro{},
ordre de grandeur et non mesure : la charge décroît beaucoup moins vite que la taille. Le niveau
absolu est illustratif, variant d'un facteur $41$ selon la source ; résistent
...
ORSA-type need, not a regulatory SCR, since the Standard Formula has no DORA module. At the scale
of a notional entity it lies between $131.5$ and $183.3$~M\euro{}, an order of magnitude rather
than a measurement: severity falls far more slowly than size. The absolute
