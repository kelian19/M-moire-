...
\paragraph{Ce que le marché observe, et ce qu'il impose au choix de données.}
Le constat n'est pas propre à la Formule Standard. L'analyse actuarielle de l'étude de marché
$2026$ sur la cyberassurance française, co-écrite pendant le stage
\citep{RapiorKaddouri2026}, relève de l'extérieur, et sous la signature de praticiens qui
observent ce marché, la même absence de traduction de l'exposition cyber en besoin de capital
réglementaire. Elle impose surtout une contrainte au présent travail : un \emph{seul} sinistre
au-delà de $10$~M\euro{} y est recensé sur l'exercice, de sorte que la distribution nationale est
censurée précisément là où se joue le quantile extrême. C'est le motif, repris au
chapitre~\ref{chap:donnees}, de calibrer la sévérité sur une base internationale plutôt que
française.

\noindent Sources : script~\texttt{63}.
