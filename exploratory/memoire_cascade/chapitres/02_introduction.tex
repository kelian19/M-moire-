...
jusqu'où peut-on l'affirmer}, à travers cinq mouvements qui s'enchaînent. On \textbf{construit}
d'abord le mécanisme, la cascade dirigée, et l'on en démontre les propriétés
(chapitre~\ref{chap:cascade}). On \textbf{délimite} ensuite ce que la
donnée permet d'en estimer : la frontière d'identifiabilité (chapitre~\ref{ch:identifiabilite}).
On \textbf{transforme} cette limite en méthode, l'identification partielle, qui borne le
capital plutôt que de poser un paramètre inconnu (chapitre~\ref{chap:partielle}). On
...
l'ordre de remédiation (chapitre~\ref{chap:resultats}). On \textbf{met en regard}, enfin, ce
...
\item Un \textbf{mécanisme} de dépendance dirigée et à l'ordre entre les piliers, la cascade,
      dont on démontre trois propriétés (chapitre~\ref{chap:cascade}, annexe~\ref{ann:cascade}) :
