...
\noindent Source de cette section : script~\texttt{31}, qui compare les régimes et imprime
le socle à contagion nulle.
...
à borner que si les extrêmes y sont \emph{atteints}. L'argument usuel, selon lequel les extrêmes d'une monotone coordonnée par coordonnée vivent aux sommets, ne s'applique \textbf{pas}
...
étroites. On procède alors par réfutation : $3\,000$ points \textbf{intérieurs} du pavé
admissible, tirés uniformément, sont évalués, et \textbf{aucun} ne sort des bornes ci-dessus, ni
en VaR ni en perte moyenne. L'hypothèse n'est pas réfutée, et les bornes sont défendables, mais
elles sont énoncées ici comme une \textbf{hypothèse vérifiée numériquement}, non comme un
...
\noindent Sources de cette section : scripts~\texttt{30}, qui énumère les sommets de
l'ensemble identifié et en tire les bornes de capital, et~\texttt{61}, qui évalue les points
\emph{intérieurs} du pavé et vérifie ainsi qu'aucun ne sort de ces bornes.
...
\noindent Source de cette section : script~\texttt{31}, qui met en regard le $W$ posé et
le $W$ borné, régime par régime.
...
remédiation est identique dans les trois configurations. Source : script~\texttt{33}.
...
résultat central du mémoire. \textbf{(a)}~Le coût de la donnée manquante, les bornes se
resserrant à mesure que l'ignorance directionnelle $t$ diminue ; c'est cette pente qui chiffre
en euros ce qu'un registre mieux spécifié apporterait. \textbf{(b)}~La lecture centrale du prior
d'expert, à l'intérieur de bornes qui, elles, n'en dépendent pas, de sorte que le résultat reste
opposable sans élicitation. \textbf{(c)}~La priorité de remédiation robuste, au sens du regret
maximal. \textbf{(d)}~La dominance majoritaire entre piliers sur l'ensemble admissible : P5
n'arrive jamais en tête, et P1 et P4 concentrent $81\,\%$ des configurations. Sources :
scripts~\texttt{30} et~\texttt{67}.}{fig:partielle}
...
\noindent Source de cette section : script~\texttt{34}, qui mesure la part de direction
captée par un rang~1 et les bornes obtenues à chaque cran de repli.
