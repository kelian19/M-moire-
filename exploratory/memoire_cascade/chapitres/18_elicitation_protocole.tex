...
%
% LE SENS DE L'ANNEXE A CHANGE DEUX FOIS. D'abord avec la decision de ne pas lancer
% l'elicitation, qui en faisait un protocole PREPARE ET NON EXECUTE. Puis le 23 septembre 2026,
% Kelian ayant precise que le questionnaire a ETE DIFFUSE : formulaire en ligne et questionnaire
% PDF adresses a une commission de l'Institut des Actuaires et a des praticiens du cabinet,
% AUCUNE REPONSE de l'Institut, aucun panel constitue. L'annexe rapporte donc une DEMARCHE et son
% issue, et non un choix. Ce qui ne change pas : l'argument chiffre du script 31 reste, et il est
% presente comme ETABLI AVANT le constat, ce qu'il etait.
%
% LES DESTINATAIRES NE SONT PAS NOMMES DANS LE MEMOIRE, meme regle que pour les repondants du
% formulaire de relecture. Nommer des personnes qui n'ont pas repondu, dans un document mis en
% ligne par l'Institut, serait deplace. Leurs noms vivent dans REPRISE.md, pas ici.
%
...
\chapter{Le protocole d'élicitation, diffusé et resté sans réponse}
...
classique à ce genre d'impasse, et un protocole complet a été construit pour cela, puis diffusé.
Aucun panel n'a pu être constitué. Cette annexe existe pour que la démarche entière soit
lisible : le protocole y est décrit, ce qui a été produit et adressé y est dit, et ce que
l'absence de panel coûte y est chiffré. La conclusion, elle, ne dépend pas de cette absence, et
c'est le dernier point qui la porte.
...
\section{Ce qui a été produit, et ce qui a été adressé}
...
\section{Pourquoi l'absence de panel ne laisse pas le mémoire démuni}
