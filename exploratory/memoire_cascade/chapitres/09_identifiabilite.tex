...
(c)~le renversement du temps laisse $S$ intacte et retourne le signe de $A$. C'est la
raison de principe pour laquelle une statistique de co-occurrence, invariante par renversement,
ne peut pas identifier un courant qui change de signe sous ce renversement.}
