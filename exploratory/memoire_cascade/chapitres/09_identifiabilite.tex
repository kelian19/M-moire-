...
(c)~le renversement du temps laisse $S$ intacte et retourne le signe de $A$ : pour une chaîne
stationnaire, une statistique invariante par renversement ne peut pas identifier ce courant.}
