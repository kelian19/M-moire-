...
\caption{La direction $A$ comme courant irréversible. (a)~le courant $J$ est non nul.
(b)~l'énergie de fluctuation (la martingale) est identique pour la chaîne posée et sa
symétrisée, elle ne voit que $S$, tandis que la production d'entropie s'efface à la
symétrisation. (c)~le renversement du temps laisse $S$ intacte et retourne $A$. Source :
script~\texttt{40}.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{Z17_postmortem_direction.png}
\caption{La direction corroborée par codage de post-mortems officiels. (a)~les transitions
codées $k\to j$ sur sept rapports. (b)~le placebo directionnel est franchi ($z=+3{,}9$), là où
il ne l'était pas sur données agrégées. (c)~P1 est source pure, P2 est puits : la structure du
classeur, retrouvée. Source : script~\texttt{53}.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{Z19_bayes_direction.png}
