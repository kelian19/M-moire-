...
ne peut pas identifier un courant qui change de signe sous ce renversement.}{fig:reversibilite}
% SOURCES-SCRIPTS: 40
...
confondant de narration reste déclaré et non levé.}{fig:postmortem}
% SOURCES-SCRIPTS: 53
...
défaillances non propagées : le niveau s'effondre, la part de direction tient.}{fig:corpus-etendu}
% SOURCES-SCRIPTS: 59
...
résultat : il en serait le \textbf{renforcement}.
% SOURCES-SCRIPTS: 54 Ce que le mémoire publie ici est une
