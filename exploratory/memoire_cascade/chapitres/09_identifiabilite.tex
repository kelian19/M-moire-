...
\noindent Source de cette section : script~\texttt{62}, pour les comptages de la fenêtre
d'événement. Le script~\texttt{35}, qui rejoue l'étude d'événement complète, exige la
chronologie PRC au format \texttt{xlsx}, absente du poste courant : sa sortie n'est pas
versionnée, et les quantités qui en dépendent restent hors contrôle automatique.
...
\emph{cause racine}, et « défaillance de gouvernance » est une conclusion de convention : le
...
ne doivent rien à la convention « cause racine = gouvernance », puisque $P_1$ n'y figure pas.
...
$P_1$. Rien de tout cela ne remplace le second codage en aveugle du script~\texttt{54}, qui
reste le remède propre et attend son second codeur. Ceci en est la borne, pas le substitut.

Le dispositif est prêt et n'attend que ce codeur. Le kit remis couvre les \textbf{dix} récits du
corpus étendu, chacun réduit aux faits établis par le rapport, sans aucune de nos flèches, et les
entités y sont anonymisées pour que le codeur ne reconnaisse pas le cas et ne se souvienne pas de
la cause racine publiée. La grille qu'il remplit porte les mêmes étiquettes anonymes que les
récits : la nommer aurait rompu l'aveuglement par le fichier de réponse lui-même. Sur les
$10 \times 10 = 100$ cellules, notre codage de référence en compte $22$ directionnelles, ce qui
donne la base d'accord sur laquelle le $\kappa$ de Cohen sera calculé dès qu'un second jeu
arrivera.
