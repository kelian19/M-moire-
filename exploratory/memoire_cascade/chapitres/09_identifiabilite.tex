...
\textbf{Les deux relectures de praticiens reçues vont dans le même sens.} Aucune ne distingue un
ordre de propagation d'une cause commune, ce qui corrobore la \emph{frontière} et non la matrice ;
la seconde conteste le sens unique de deux arcs sans déplacer le capital publié, l'ensemble
admissible ne fixant aucune direction (\S\ref{sec:relecture-praticien}).
\end{attention}
