...
\begin{attention}
\textbf{Articulation avec la section~\ref{sec:formalisation}, pour éviter une lecture en
double.} Le chapitre~\ref{chap:cascade} clôt sa construction par un bloc de définitions et
d'énoncés (\S\ref{sec:formalisation}) dont les démonstrations sont reportées à
l'annexe~\ref{ann:cascade} : c'est la \emph{spécification} du modèle, écrite d'un bloc pour
être opposable. Le présent chapitre en isole les \textbf{trois propriétés qui portent
l'argument} du mémoire, et les démontre \emph{sur place} en les accompagnant chacune de sa
vérification numérique. Le recouvrement est donc voulu et il est limité à ces trois énoncés :
on lira \S\ref{sec:formalisation} pour la spécification complète, et ce chapitre pour ce que
les propriétés \emph{prouvent}. Les propositions y sont numérotées séparément, l'annexe
renvoyant à celles de \S\ref{sec:formalisation}.
\end{attention}
...
\begin{proposition}[Dépendance à l'ordre]\label{prop:ordre-dem}
...
proposition~\ref{prop:ordre-dem} exhibe donc un objet que \emph{aucune} telle mesure ne reproduit,
...
\begin{proposition}[Borne de propagation]\label{prop:leontief-dem}
...
\end{equation}
Alors $\rho(W)\leq g<1$, et la conclusion de la proposition~\ref{prop:leontief-dem} vaut sans
