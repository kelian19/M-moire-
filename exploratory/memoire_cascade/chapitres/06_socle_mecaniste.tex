...
atome. Elles demandent une composante de sauts. On pourrait objecter qu'une gaussienne
...
% SOURCES-SCRIPTS: 08b
échelle n'est donc pas ajoutée pour enrichir le modèle, elle est identifiée par la
surdispersion.
