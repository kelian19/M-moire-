...
compte, et il rejoint celui du taux de dépassement gelé au \S\ref{sec:pu-coherence} : les deux
seuls défauts d'estimation du mémoire vont du même côté, celui de la sous-estimation, quand
tous ses choix \emph{posés} vont du côté prudent. C'est aussi ce qui justifie de rapporter les
