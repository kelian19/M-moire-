...
La théorie des valeurs extrêmes étudie le comportement asymptotique des maxima, comme le théorème
central limite celui des sommes. Deux résultats autorisent l'extrapolation de queue sur laquelle
repose la sévérité.
...
\noindent L'approche par maxima de blocs ne retient qu'une observation par bloc. Le mémoire lui
préfère l'approche par dépassement de seuil, qui exploite toutes les pertes au-delà d'un seuil $u$
et repose sur le théorème suivant, où
...
\noindent Pour $\xi>0$ la queue est lourde : la variance de la sévérité est infinie dès
$\xi\ge 1/2$, son espérance dès $\xi\ge 1$. Les énoncés développés et les éléments de
démonstration sont au \S\ref{sec:ann-evt}.
...
lois asymptotiques de cet estimateur et de l'estimateur de Hill sont données au
\S\ref{sec:ann-estimation-queue}.
...
\noindent La démonstration est au \S\ref{sec:ann-estimation-queue}.
