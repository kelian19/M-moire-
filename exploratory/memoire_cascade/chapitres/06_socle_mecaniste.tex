...
Pour $\xi > 0$, l'estimateur non paramétrique de Hill (1975) estime l'indice de queue à partir des $k$ plus grandes statistiques d'ordre, sans passer par l'ajustement d'une loi paramétrique. Sa définition est donnée par l'équation~\eqref{soc:eq:hill}, à l'endroit où il sert de diagnostic. Asymptotiquement convergent et sans biais lorsque la loi appartient au domaine d'attraction de Fréchet, il présente en échantillon fini un biais majeur : si la composante à variation lente de la queue ne converge pas assez vite, $\hat{\xi}_{\text{Hill}}$ devient instable.
...
\subsection{La dynamique du facteur systémique et la nécessité de deux échelles d'aléa}
...
accumulation en temps continu est donc un \textbf{mouvement brownien}. Cette forme est imposée par la
