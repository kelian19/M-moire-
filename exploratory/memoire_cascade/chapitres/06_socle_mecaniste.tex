...
démonstration sont déportés \matcomp.
...
et réduit. Sa dynamique, détaillée \matcomp, superpose un bruit de fond
...
\emph{Hill plot} \matcomp, il ne corrobore pas ce niveau par sa valeur,
