...
et $\hat\xi$ reste stable autour de $0{,}60$ quand on fait varier le seuil. Les tests formels
...
Anderson-Darling $p=0{,}87$, Kolmogorov-Smirnov $p=0{,}87$. Enfin, la \textbf{couverture réelle}
...
paramétrique et statistique observée ($p=0{,}87$). \textbf{(f)} adéquation de la fréquence :
