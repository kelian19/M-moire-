...
(\S\ref{sec:pu-coherence}), du même traitement que le taux de dépassement. Ce que ce résultat ne
touche pas est la \textbf{thèse}, qui porte sur un rapport entre états de conformité à sévérité
de base commune : une dérive commune aux deux états se simplifie dans un rapport.
Source : script~\texttt{89}.
\end{cle}
