...
l'intervalle de confiance) et \texttt{63} (calibration figée).
...
\texttt{47} (validation) et \texttt{63} (calibration figée).
...
\noindent Chiffres de cette section : scripts~\texttt{47} et \texttt{63}.
