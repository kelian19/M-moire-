...
notifications/an), est décomposée en sous-fréquences par vecteur d'attaque,
...
PRC comptent des \emph{notifications de violation de données}, sur un périmètre américain et
sans seuil de matérialité. Ce nombre sert exclusivement à répartir la sinistralité entre
