...
(c)~la lecture dynamique $\Prob(\tau\le 1\text{ an})$ vaut environ le double de la
statique.}
% SOURCES-SCRIPTS: 52
...
tiers. Le cadre complet, avec les hypothèses effectivement requises, est déporté
\matcomp.
...
\item le premier rapport d'incidents DORA des ESAs \citep{esas2026_incidents} établit que
      $29\,\%$ des $3\,383$ incidents TIC majeurs de $2025$ proviennent d'une
...
\item l'analyse des registres d'externalisation par la BCE \citep{ecb2024_outsourcing} montre que
      ...
      critique à $30$), et les ESAs ont désigné $19$ fournisseurs TIC critiques : cela
...
l'IC90 de $\hat\xi$. Le classement des deux premières paires n'est pas résolu et n'a pas à
...
(figure~\ref{fig:interaction-canaux}).
% SOURCES-SCRIPTS: 100
...
chaîne publiée reste au taux historique, la calibration étant gelée (figure~\ref{fig:roi}).
