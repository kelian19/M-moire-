...
$\VaR_\alpha(L),\ \TVaR_\alpha(L)$ & Value-at-Risk et Tail-VaR de la charge \textbf{annuelle agrégée} $L$, au niveau $\alpha=99{,}5\,\%$ : ce sont les \emph{mesures de capital} & \ref{chap:socle} \\
...
\noindent Sources des valeurs citées : scripts~\texttt{63} (calibration figée)
et~\texttt{67} (paramètres posés et constantes), ainsi que~\texttt{22} et~\texttt{50}
(taux de coût du capital, historique et révisé).
