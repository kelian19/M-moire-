...
la table des paramètres du mémoire : celle-là dit ce qui est calibré ou posé,
...
\caption{Les deux réserves sur leur rectangle. (a)~le capital, avec la ligne plate à
$\kappa = 0{,}5\,\%$ où la sensibilité à $\theta$ est nulle. (b)~le terme d'interaction, positif
sous $\theta = 1$, nul le long de cette ligne et négatif au-delà : c'est le changement de signe
qui fait du plafond un amortisseur et non un contrepoids. L'axe des plafonds est ordinal, son
dernier cran étant l'absence de plafond.}
% SOURCES-SCRIPTS: 86 109
\label{fig:plafond-saturation-3d}
\end{figure}
