...
% Source : chapitres/05_donnees_limites.tex, moins les sections
...
\section{Pourquoi le dispositif s'arrête à ces sources}
...
source, figure dans la version longue de ce mémoire.

\noindent Sources : scripts~\texttt{05}, \texttt{62} et~\texttt{63}.
