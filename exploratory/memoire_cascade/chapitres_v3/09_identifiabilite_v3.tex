...
% Source : chapitres/09_identifiabilite.tex, moins les sections
...
\section{Le biais de narration du corpus}
...
d'être posée. Le protocole et les trois mesures sont dans la version longue de ce mémoire.

\noindent Sources : scripts~\texttt{54} et~\texttt{64}.

\section{Les séquences ordonnées, une voie refermée}
% PONT v3 : la section complete est dans main_v2, version
% longue et non modifiee. Genere par construire_v3.py.
...
dans la version longue de ce mémoire.

\noindent Sources : script~\texttt{75}.

\section{La lecture bayésienne de la direction}
% PONT v3 : la section complete est dans main_v2, version
% longue et non modifiee. Genere par construire_v3.py.
\label{sec:bayes}
...
ne le révèle pas, il le remplace. Le développement est dans la version longue de ce mémoire.

\noindent Sources : script~\texttt{56}.
