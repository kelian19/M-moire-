...
% Source : chapitres/06_socle_mecaniste.tex, moins les sections
...
\section{Ce qui autorise l'extrapolation de queue}
...
sont repris dans la version longue de ce mémoire. Ce qui importe ici est la conséquence : la forme
...
\section{Deux estimateurs de l'indice de queue, et ce que leur écart signifie}
% PONT v3 : la section complete est dans main_v2, version
% longue et non modifiee. Genere par construire_v3.py.
...
protocole et les six valeurs sont dans la version longue de ce mémoire.

\noindent Sources : scripts~\texttt{47}, \texttt{63} et~\texttt{67}.
