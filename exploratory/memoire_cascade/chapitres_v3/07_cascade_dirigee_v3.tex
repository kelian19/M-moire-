...
% Source : chapitres/07_cascade_dirigee.tex, moins les sections
...
\section{Les trois propriétés, vérifiées numériquement}
...
l'annexe~\ref{ann:cascade} et les vérifications numériques correspondantes dans la version longue de ce mémoire.

\noindent Sources : scripts~\texttt{03} et~\texttt{40}.
