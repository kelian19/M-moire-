...
% Source : chapitres/11_conformite_multietats.tex, moins les sections
...
\section{Le statut des valeurs du gain de propagation}
...
Le balayage qui établit cette monotonie, et la table des valeurs alternatives, sont dans la version longue de ce mémoire.

\noindent Sources : scripts~\texttt{66} et~\texttt{67}.
