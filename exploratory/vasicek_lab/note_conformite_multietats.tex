...
\noindent Ce document accompagne les scripts \texttt{16} (état global), \texttt{16b} (état
par pilier) et \texttt{17} (Markov et trajectoire) du dossier \texttt{vasicek\_lab}. Il sera
complété au fil du chantier (script~\texttt{18}, priorisation de la remédiation).
...
Le Delta\_DORA (NC contre C), en bootstrap deux niveaux (multiplicateurs $+$ sévérité), reste
du même ordre que le mémoire, amplifié par la propagation : OpRisk médiane $6230$~M\euro{}
(IC90 $[1997\,;34195]$, mémoire $3879$), PRC médiane $2995$~M\euro{} (IC90 $[2461\,;3396]$,
mémoire $2015$), et $100\,\%$ des tirages positifs. Le surcoût intermédiaire (PC contre C) est
chiffré pour la première fois : OpRisk médiane $2404$~M\euro, PRC $1082$~M\euro.
...
\textbf{l'interaction} : le Delta total (tous NC contre tous~C, $10\,927$~M\euro) dépasse la
somme des $\Delta_k$ ($9\,531$~M\euro) de $+1\,395$~M\euro. Le surcoût de la non-conformité
totale est \emph{super-additif}, précisément parce que la cascade fait interagir les piliers,
...
\texttt{18}  & (à venir) priorisation de la remédiation & --- \\
\bottomrule
\end{tabularx}
