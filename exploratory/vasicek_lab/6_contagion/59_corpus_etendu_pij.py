...
#                        ceux qui n'ont rien entraine. C'est le DENOMINATEUR de p_jk, et c'est
#                        l'ajout de ce script. Il contient necessairement les piliers
#                        apparaissant dans les transitions ; il peut en contenir d'autres.
