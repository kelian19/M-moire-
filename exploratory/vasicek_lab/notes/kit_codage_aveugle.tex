...
\title{\vspace{-1.2cm}\color{navy}\bfseries Sept incidents, une question simple\\[2pt]
...
\begin{cle}
\textbf{Ce qu'on vous demande.} Vous allez lire sept récits d'incidents réels, tirés de rapports
...
trois quarts d'heure. Aucune connaissance technique n'est nécessaire : les faits vous sont
...
\begin{tabular}{@{}p{2.05cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}|p{1.42cm}@{}}
\toprule
\textbf{Incident} & Gouv. \newline / Incid. & Gouv. \newline / Tests & Gouv. \newline / Prest. &
