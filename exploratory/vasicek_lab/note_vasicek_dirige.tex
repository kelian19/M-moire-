...
% --- mise en page : titres, légendes, flottants ---
...
\begin{attention}
\textbf{Trois niveaux de finesse pour le chargement --- le point à trancher avec le tuteur.}
...
\end{equation}
En clair : P2 reçoit $0{,}5$ de P1 et $0{,}4$ de P4 ; P4 reçoit $0{,}3$ de P1. Le $0{,}62$
...
\begin{attention}
\textbf{Ce que ce banc d'essai prouve --- et ne prouve pas.} Les sévérités sont simulées
\emph{déjà} en loi de Pareto : l'EVT ne peut qu'y gagner. Il ne \og{}prouve\fg{} donc pas que le
...
\begin{cle}
\textbf{À retenir.} \emph{(A)} un facteur systémique \textbf{par pilier} $\Y_j$ et une
...
\clearpage
\section{Décisions à trancher et données : l'agenda tuteur}
