% Point d'avancement tuteur, 14 aout 2026. HUIT slides.
% Continuite du 07/08, qui se terminait sur "deux parametres ont change de statut".
...
\textbf{(A)} Ce que le capital \textbf{coûte}, et s'il vaut mieux le détenir ou le
transférer. C'est un axe que nous n'avions jamais ouvert.\\[3pt]
\textbf{(B)} Les \textbf{deux biais} d'OpRisk que nous déclarions depuis le début, enfin
chiffrés au lieu d'être seulement signalés.\\[3pt]
\textbf{(C)} La \textbf{direction}, sur un corpus élargi et sur la matrice \emph{complète}
plutôt que sur le seul sens à l'intérieur des paires.
\end{block}
\vspace{1mm}
...
% =====================================================================
\section*{A. Ce que le capital coûte}

\begin{frame}{Détenir ou transférer}
\scriptsize
Nous comparions notre SCR à la Formule Standard, aux pertes réelles et au marché cyber.
Trois comparaisons de \textbf{niveau}. Il en manquait une de \textbf{prix} : un SCR n'est pas
une perte, c'est du capital \emph{immobilisé}, et Solvabilité~II en chiffre le coût
($6\,\%$, ramené à $\mathbf{4{,}75\,\%}$ par la directive (UE)~2025/2).
\begin{center}
...
% =====================================================================
\section*{B. Deux biais enfin chiffrés}
...
% =====================================================================
\section*{C. La direction, sur la matrice complète}
...
% =====================================================================
\section*{D. La décision sur l'élicitation}
