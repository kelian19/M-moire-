...
($848$~M\euro/an). \alert{\textbf{Deux mises à jour.}} Le taux n'est plus $6\,\%$ mais
$\mathbf{4{,}75\,\%}$ : la directive (UE)~2025/2 l'a abaissé, transposition due pour janvier
2027. Et surtout, le portage se retourne en une \emph{question} : si détenir coûte, vaut-il
mieux \textbf{transférer} ?
\begin{center}
\includegraphics[width=0.86\linewidth]{S19_detenir_ou_transferer.png}
\end{center}
\vspace{-2mm}
\begin{block}{Trois chiffres, et une borne}
À l'échelle d'entité, détenir coûte $\mathbf{23{,}2}$~M\euro/an contre $9{,}7$ de sinistralité
attendue, soit $\mathbf{2{,}4}$ fois. Multiple de capital $\mathbf{50}$ à l'entité contre
$8{,}3$ au secteur. Le traité optimal ($L^\star=\mathrm{SCR}=488$) ramène le coût à $12{,}3$,
soit $\mathbf{-47\,\%}$. \textbf{Borne supérieure} : il faudrait $\mathbf{77\,\%}$
