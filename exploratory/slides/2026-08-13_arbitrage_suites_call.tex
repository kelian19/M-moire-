...
\begin{frame}{Les quatre décisions que je ne peux pas prendre}
\scriptsize
\begin{block}{1. La définition de l'écart entre états \hfill \emph{la plus urgente}}
$-53\,\%$ à gain de propagation figé, ou facteur $3{,}34$ à quatre canaux. Deux définitions,
deux questions différentes. Le mémoire doit dire laquelle il publie.
\end{block}
\vspace{-1.5mm}
\begin{block}{2. Le niveau de l'intervalle reporté}
$90$ ou $95\,\%$. Aucune calibration ne bouge, toutes les bornes publiées bougent, et la
sous-couverture n'est pas corrigée dans un cas comme dans l'autre.
\end{block}
\vspace{-1.5mm}
\begin{block}{3. Les six pages des scénarios par taille}
Le résultat utile tient en une page et demie. Ce qui doit rester quoi qu'il arrive est la limite
qui justifie la borne supérieure.
\end{block}
\vspace{-1.5mm}
\begin{block}{4. Le renommage dans le code}
Le gain de propagation et l'échelon de sévérité portent des noms qui ne diffèrent que par un
tiret bas. Vingt-sept fichiers, sur un pipeline gelé.
\end{block}
\end{frame}
