...
\vspace{2pt}
\begin{reflexe}
\textbf{La phrase à placer deux fois, minimum} (slide 7, puis en clôture)~:\\
...
(slides 3 à 7) \textbf{21} \textbullet{} partie B (8 et 9) \textbf{10} \textbullet{} clôture
\textbf{7}, et \textbf{4 de marge} rendues par la slide retirée, qui iront aux questions.
\textbf{Les deux slides à ne jamais presser sont la 4 et la 7}~: l'échelle, et le
...
validation~: la validation, c'est la slide 6 et les tests d'adéquation.}
\ench{Sur quel point ne faut-il pas parier~?}

% La slide « Ramené à une entité » (169 contre 450 de forfait) a été RETIRÉE du deck le
% 7 août 2026 : la comparaison de niveau au forfait n'est pas défendable. Ses réponses
% préparées sont passées dans la banque de questions, en fin de document.
\slide{6. Sur quel point ne pas parier}{4 min}
...
\slide{7. Capital libéré}{6 min \textemdash{} placer la phrase}
...
\slide{8. Jacobs}{4 min \textemdash{} vérification demandée}
...
\slide{9. La fréquence}{5 min \textemdash{} vérification demandée}
...
\slide{10. Points bloquants}{4 min \textemdash{} clôture}
...
\begin{alerte}
\footnotesize
\textbf{Les six questions à anticiper.}\\[3pt]
...
entre états et l'ordre des piliers.\\[3pt]
\textbf{\og Et par rapport à la Formule Standard ?\fg} \emph{(la slide a été retirée~: ne pas
ouvrir le sujet, savoir y répondre.)} $\rightarrow$ le forfait opérationnel vaut $450$~M\euro{}
sur ce bilan quand mon besoin cyber en vaut $169$, soit $0{,}38$ fois, \textbf{mais ce rapport
ne mesure rien}~: le forfait est 3\,\% des provisions techniques, donc il suit l'encours et pas
l'empreinte informatique, et sur mes quatre bilans \textsc{sfcr} il va de $0{,}04$ à $2{,}07$
selon le mix. \emph{Ce qui est stable, c'est qu'il vaut la même chose pour un profil exemplaire
et pour un profil défaillant, écart nul, quand mon modèle écarte les deux de $+45\,\%$, et ce
plancher tient sur les quatre entités.} \textbf{Ne pas dire} que le forfait sous-estime~: sur la
seule entité où ma sévérité est dans son domaine, il couvre $28$ fois mon besoin.\\[3pt]
\textbf{\og Et sur des entités réelles ?\fg} $\rightarrow$ quatre bilans \textsc{sfcr} publiés.
La part attribuée à \textsc{dora} va de $2{,}0\,\%$ pour un grand assureur vie à $41{,}3\,\%$
pour une petite non-vie. Deux des quatre \textsc{scr} sont déduits d'un taux de couverture, et
\textbf{je borne cet effet à $\pm10\,\%$}~: les ordres de grandeur tiennent. \emph{Les trois
plus petites sont hors du domaine de validité de ma sévérité, et je le dis avant qu'on me le
demande.}
\end{alerte}
