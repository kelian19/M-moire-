% =====================================================================================
% QUESTIONNAIRE D'ELICITATION -- version 3, 19 septembre 2026
%
% CE QUI CHANGE EN VERSION 3, ET C'EST LA PARTIE A EN ENTIER. Les neuf graines de la v2 etaient
% justes mais elles n'etaient pas CONTROLEES : rien ne verifiait qu'une graine soit bien une
% grandeur realisee, qu'elle ne soit pas devinable, ni qu'elle n'en double pas une autre. Le
% script 105 les recalcule sur les deux bases et leur applique QUATRE controles : caractere
% realise, non-degenerescence, respect des bornes naturelles, pouvoir de separation entre
% experts. Trois consequences :
%   - le GINI de concentration (A7 en v2) est ECARTE : il fait doublon avec la graine qui compte
%     les incidents portant la moitie du volume, et sa valeur vraie de 0,97 se devine sans rien
%     connaitre du dossier. Une graine se juge sur ce qu'elle separe, pas sur ce qu'elle mesure ;
%   - trois graines de la v2 portaient sur des grandeurs que le depot ne calcule PAS directement
%     (cause commune par jour, nombre maximal de victimes en une journee, incidents TIC materiels
%     par an d'une grande entite). Elles sont remplacees par des grandeurs que le script 105
%     imprime, faute de quoi la notation reposerait sur un chiffre invérifiable, ce que la
%     consigne du formulaire promet pourtant au repondant ;
%   - la partie A passe de neuf a DIX graines, le retrait de la graine sur xi en v2 ayant laisse
%     le dispositif sous le seuil que le protocole annonce.
% Les valeurs vraies vivent dans sorties_verif/105.txt et ne sont JAMAIS imprimees ici.
%
% VERSION 2, 13 aout 2026
%
...
\pagestyle{fancy}
\fancyhf{}
\lfoot{\footnotesize Élicitation $W$ --- version 3.0 du 19 septembre 2026}
...
\footnotesize\emph{Dix quantités effectivement mesurées dans les données de l'étude. Leur
...
et personne n'est censé en connaître les valeurs de mémoire. Répondez à l'intuition, sans
chercher : c'est exactement ce que la méthode mesure.}
\normalsize
...
\endhead
A1. Délai médian entre la survenance d'un incident et sa déclaration, en jours & & & \\ \hline
A2. Part des incidents déclarés plus de quatre-vingt-dix jours après leur survenance, en \% & & & \\ \hline
A3. Délai médian de déclaration pour les seuls incidents de type \emph{piratage}, en jours & & & \\ \hline
A4. Durée médiane entre le début et la fin d'exposition d'un incident, en jours & & & \\ \hline
A5. Nombre médian d'enregistrements touchés par incident & & & \\ \hline
A6. Nombre d'incidents qui portent à eux seuls la moitié du volume touché sur sept exercices & & & \\ \hline
A7. Part des incidents dont l'exposition a duré plus de trente jours, en \% & & & \\ \hline
A8. Part des incidents de type \emph{piratage} parmi ceux dont le vecteur est renseigné, en \% & & & \\ \hline
A9. Part des lignes de la base qui sont des doublons de notification d'un même incident, en \% & & & \\ \hline
A10. Rapport du quatre-vingt-dix-neuvième centile à la médiane des pertes cyber du secteur financier & & & \\ \hline
\end{longtable}
